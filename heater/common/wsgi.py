...
from heater.common import exception
from heater.openstack.common import gettextutils
from heater.openstack.common import importutils
...
api_group = cfg.OptGroup('heater_api')
cfg.CONF.register_group(api_group)
cfg.CONF.register_opts(api_opts,
                       group=api_group)

cfg.CONF.import_opt('debug', 'heater.openstack.common.log')
cfg.CONF.import_opt('verbose', 'heater.openstack.common.log')
