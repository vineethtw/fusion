...
api_group = cfg.OptGroup('fusion_api')
cfg.CONF.register_group(api_group)
cfg.CONF.register_opts(api_opts,
                       group=api_group)

cfg.CONF.import_opt('debug', 'fusion.openstack.common.log')
cfg.CONF.import_opt('verbose', 'fusion.openstack.common.log')
